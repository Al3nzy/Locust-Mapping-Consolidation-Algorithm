...
public class VmSchedulerTimeSharedOverSubscription extends VmSchedulerTimeShared {
	 ...
	 * policy still allows the allocation of VMs that require more CPU capacity that
	 * is available. Oversubscription results in performance degradation. Each
	...
	protected boolean allocatePesForVm(String vmUid, List<Double> mipsShareRequested) {
		...
		if (getAvailableMips() >= totalRequestedMips) {
			...
			double alanzy= getAvailableMips();
