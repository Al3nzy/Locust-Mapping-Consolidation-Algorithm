 ...
 */
// Alanzy 
// I did not find any algorithm call this class without the extended class (this only for researching... ) 
//needed a extended class to do the optimized algorithm to select the VM to migrate it after assign it at first.
