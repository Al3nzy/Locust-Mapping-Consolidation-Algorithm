...
public class EdgeSwitch extends Switch {
	...
	/**
	 * Constructor for Edge Switch We have to specify switches that are connected to
	 * its downlink and uplink ports, and corresponding bandwidths. In this switch
	 * downlink ports are connected to hosts not to a switch.
	 * 
