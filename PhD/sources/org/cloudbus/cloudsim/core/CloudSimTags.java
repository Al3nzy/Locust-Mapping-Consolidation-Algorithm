...
public class CloudSimTags {
	...
	/**
	 * Denotes insignificant simulation entity or time. This tag will not be used
	 ...
	 * reservation. This tag is normally used between CloudInformationService and
	 * CloudSim entity.
	 */
	...
	/**
	 * Denotes grid resource allocation policy. This tag is normally used between
	 * CloudSim and CloudResource entity.
	 */
	 ...
	 * resource. This tag is normally used between CloudSim and CloudResource
	 * entity.
	 */
	public static final int RESOURCE_NUM_PE = BASE + 8;

	/**
	 * Denotes a request to get the total number of free Processing Elements (PEs)
	...
	/**
	 * Denotes request for grid resource characteristics information. This tag is
