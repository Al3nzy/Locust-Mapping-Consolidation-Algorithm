...
public final class DataCloudTags {
	...
	/**
	 * Denotes a list of Replica Catalogue (RC) entities that are listed in other
	 * regional Data GIS entities. This tag should be called from a user to Data
	 * GIS.
	 */
	...
	/**
	 * Denotes the submission of a DataCloudlet. This tag is normally used between
	 * user and DataCloudResource entity.
	 */
	...
	/**
	 * Sends the file to the requester. The format of the reply is File or null if
	 * error happens
	 */
	...
	/**
	 * Denotes that file deletion is failed because the file does not exist in the
	 * storage nor catalogue
	 */
	...
	/**
	 * Denotes that file modification is failed because the file is currently used
	 * by others
	 */
	public static final int FILE_MODIFY_ERROR_IN_USE = RM_BASE + 64;

	/**
	 * Denotes that file modification is failed because access/permission denied or
	 * not authorized
	 */
	 ...
	 * The format of the reply is Object[3] = {String filename, Integer uniqueID,
	 * Integer resultID}.<br>
	 * NOTE: The result id is in the form of CTLG_ADD_MASTER_XXXX where XXXX means
	...
	/**
	 * Denotes that master file deletion is failed because the file does not exist
	 * in the catalogue
	 */
	public static final int CTLG_DELETE_MASTER_DOESNT_EXIST = CTLG_BASE + 24;

	/**
	 * Denotes that master file deletion is failed because replica files are still
	 * in the catalogue. All replicas need to be deleted first.
	 */
	 ...
	 * The format of the reply is Object[2] = {String lfn, Integer resultID}.<br>
	 * NOTE: The result id is in the form of CTLG_ADD_REPLICA_XXXX where XXXX means
	 * the error/success message
	 */
	...
	/**
	 * Denotes that replica file addition is failed because the given file name does
	...
	/**
	 * Denotes that replica file deletion is failed because the file does not exist
	 * in the catalogue
	 */
	...
	/**
	 * Denotes the request to modify an existing master file information stored in
	 * the Replica Catalogue.<br>
	 * The format of this request is Object[3] = {String filename, FileAttribute
	 * attr, Integer resID}.<br>
	...
	/**
	 * Denotes that master file modification is failed because the file attribute is
	 * set to a read-only
	 */
