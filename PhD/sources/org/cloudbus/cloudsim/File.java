...
public class File {
	 ...
	 * @throws ParameterException This happens when one of the following scenarios
	 *                            occur:
	 *                            <ul>
	...
	/**
	 * Copy constructor, i.e. cloning from a source file into this object, but this
	 * object is set to a <b>replica</b>
	 * 
	 ...
	 * 
	 * @return a clone of this file (as a master copy) or <tt>null</tt> if an error
	 *         occurs
	 */
	 ...
	 * NOTE: This object size is NOT the actual file size. Moreover, this size is
	 * used for transferring this object over a network.
	 * 
	 ...
	 * 
	 * @param readOnly a flag denotes <tt>true</tt> for read only or <tt>false</tt>
	 *                 for re-writeable
	 */
	...
	/**
	 * Sets the current transaction time (in second) of this file. This transaction
	 * time can be related to the operation of adding / deleting / getting this file
	 * on a resource's storage.
	 * 
