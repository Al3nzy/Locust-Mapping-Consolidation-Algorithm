...
public class InfoPacket implements Packet {
	...
	/**
	 * Returns the number of hops that this packet has traversed. Since the packet
	 * takes a round trip, the same router may have been traversed twice.
	 * 
	 ...
	 * basically the RTT. Dividing this by half should be the approximate latency.
	 * <p>
	 ...
	 * 
	 * @param time current simulation time, use {@link gridsim.CloudSim#clock()} to
	 *             obtain this
	 * @pre time >= 0
	 * @post $none
	 */
	...
	/**
	 * Every entity that the InfoPacket traverses should add the baud rate of the
	 * link on which this packet will be sent out next.
	 * 
