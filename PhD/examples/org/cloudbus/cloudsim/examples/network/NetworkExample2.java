...
public class NetworkExample2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			TopologicalNode n1 = new TopologicalNode(0);
			TopologicalNode n2 = new TopologicalNode(1);
			TopologicalNode n3 = new TopologicalNode(2);

			TopologicalLink l1 = new TopologicalLink(0, 1, 1.2f, 10f);
			TopologicalLink l2 = new TopologicalLink(0, 2, 1.2f, 10f);

			TopologicalGraph gf = new TopologicalGraph();
