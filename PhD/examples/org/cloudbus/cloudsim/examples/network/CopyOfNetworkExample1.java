...
/**
 * note/ in my work I have 1 data center and host nodes as a moniter node A
 * simple example showing how to create a datacenter with one host and a network
 * topology and and run one cloudlet on it.
 */
public class CopyOfNetworkExample1 {
	...
	// I create this class to make a list of VM (alanzy)
	...
	public static void main(String[] args) {
		...
		try {
			...
			// For more DATACENTERS Mohammed alanzy
			/*
			 * Datacenter datacenter1 = createDatacenter("Datacenter_1"); Datacenter
			 * datacenter2 = createDatacenter("Datacenter_2"); Datacenter datacenter3 =
			 * createDatacenter("Datacenter_3"); Datacenter datacenter4 =
			 ...
			 * 
			 * //VM description int vmid = 0; int mips = 250; long size = 10000; //image
			 * size (MB) int ram = 512; //vm memory (MB) long bw = 1000; int pesNumber = 1;
			 * //number of cpus String vmm = "Xen"; //VMM name
			 * 
			 * //create VM Vm vm1 = new Vm(vmid, brokerId, mips, pesNumber, ram, bw, size,
			 * vmm, new CloudletSchedulerTimeShared());
			 * 
			 * //add the VM to the vmList vmlist.add(vm1);
			 */
			...
			cloudletList = createCloudlet(brokerId, 5); // creating 40 cloudlets

			/*
			 * //Cloudlet properties int id = 0; long length = 40000; long fileSize = 300;
			 * long outputSize = 300; UtilizationModel utilizationModel = new
			...
			/*
			 * //add the cloudlet to the list cloudletList.add(cloudlet1);
			 * 
			...
			NetworkTopology.buildNetworkTopology(
					"D:\\Cloudsim\\cloudsim-3.0.3\\examples\\org\\cloudbus\\cloudsim\\examples\\network\\topology.brite");
