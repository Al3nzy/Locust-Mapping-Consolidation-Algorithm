...
import org.cloudbus.cloudsim.power.PowerVmAllocationPolicyLACE;
...
import org.cloudbus.cloudsim.power.PowerVmAllocation_LACE;
//import org.cloudbus.cloudsim.power.PowerVmAllocation_LACE;
	...
	protected VmAllocationPolicy getVmAllocationPolicy(String vmAllocationPolicyName, String vmSelectionPolicyName,
		...
		if (vmAllocationPolicyName.equals("iqr")) {
			...
			vmAllocationPolicy = new PowerVmAllocationPolicyMigrationStaticThreshold(hostList, vmSelectionPolicy,
					parameter);
		} else if (vmAllocationPolicyName.equals("LACE")) {	
			vmAllocationPolicy = new PowerVmAllocation_LACE(hostList, vmSelectionPolicy,
				parameter);
