...
public class NetworkTopology {
	...
	/**
	 * Creates the network topology if file exists and if file can be succesfully
	 * parsed. File is written in the BRITE format and contains topologycal
	 ...
	 * problem during creation of network (e.g., during parsing of BRITE file) that
	 * does not allow a proper simulation of the network, this method returns false.
	 * 
