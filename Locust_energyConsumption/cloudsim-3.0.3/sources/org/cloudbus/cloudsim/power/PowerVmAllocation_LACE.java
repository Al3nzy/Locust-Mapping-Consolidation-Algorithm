...
public class PowerVmAllocation_LACE extends Locust_GlobalMigration_LACE {
	...
	private static double alpha=1.0; // To get same as in the paper that published then this one should be 1.0 otherwise the energy will increased and the number of migration will be decreased. i.e., if less than 1 
