...
public class Host {
	 ...
	 * (Alanzy)This function will check PE, MIPS, RAM, and BW and can be customized by cloud provider (developer )to add more checking parameters 
	 * @param vm the vm
	 ...
	 * Alanzy (here to check how many times came here to check the Host resources)
