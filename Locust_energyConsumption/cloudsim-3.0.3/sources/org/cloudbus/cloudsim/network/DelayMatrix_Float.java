...
public class DelayMatrix_Float {
	...
	/**
	 * private constructor to ensure that only an correct initialized delay-matrix
	 * could be created
	 */
	 ...
	 * @param directed true if an directed matrix should be computed, false
	 *                 otherwise
	 */
	 ...
	 * graph for similarity we assume all kommunikation-distances are symmetrical
