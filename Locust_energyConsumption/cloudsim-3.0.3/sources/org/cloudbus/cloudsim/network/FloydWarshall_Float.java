...
public class FloydWarshall_Float {
	 ...
	 *
	 * double[][] adjMatrix = { {0, 1, 0, 0, 1}, {1, 0, 1, 3, 0}, {0, 1, 0, 2, 0},
	 * {0, 3, 2, 0, 1}, {1, 0, 0, 1, 0}, };
	 * 
	 * 
	 ...
	 * i=0;i<n;i++){ s0.append("Node "+i+" to others:"); for(int j=0;j<n;j++){
	 ...
	 * 
	 * 
	 * Log.printLine("Path information"); for(int i=0;i<n;i++){ for(int
	 * j=0;j<n;j++){ Log.print("From "+i+" to "+j+": "); int pre=Pk[i][j];
	 * while((pre!=-1)&&(pre!=i)){ Log.print(" <-  "+ pre); pre=Pk[i][pre];
	 * if((pre==-1)||(pre==i)) Log.print(" <-  "+ pre); } Log.printLine("\n"); } }
	 * 
	 * }
	 * 
	 */
