...
public class CloudletList {
	...
	public static <T extends Cloudlet> void sort(List<T> cloudletList) {
		Collections.sort(cloudletList, new Comparator<T>() {
			 ...
			 * @return the value 0 if both Objects are numerically equal; a value less than
			 *         0 if the first Object is numerically less than the second Object; and
			 *         a value greater than 0 if the first Object is numerically greater
