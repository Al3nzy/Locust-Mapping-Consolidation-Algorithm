...
public class ResCloudletList {
	...
	/**
	 * Returns a given Cloudlet. This method needs a combination of Cloudlet Id and
	 * User Id because each Cloud Users might have exactly same Cloudlet Ids.
	 * 
	 * @param cloudletId a Cloudlet Id
	 * @param userId     an User Id
	 * @param list       the list
	 * @return the Cloudlet.
	 * @throws IndexOutOfBoundsException - if a Cloudlet with specified Id and user
	...
	/**
	 * Returns the position of the cloudlet with that id, if it exists. Otherwise
	 * -1.
	 * 
