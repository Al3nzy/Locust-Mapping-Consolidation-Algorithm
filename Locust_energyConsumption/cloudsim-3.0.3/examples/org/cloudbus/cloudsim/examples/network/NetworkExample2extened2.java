 ...
 */
public class NetworkExample2extened2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			TopologicalGraph graph = networkTopologyReturning.buildNetworkTopologyReturn(
					"E:\\Alanzy\\Desktop\\Cloudsim\\cloudsim-3.0.3\\bin\\org\\cloudbus\\cloudsim\\examples\\network\\topology.brite");
			...
			briteNode = 5;
			NetworkTopology.mapNode(cloudlet1.getCloudletId(), briteNode);
			briteNode = 6;
			NetworkTopology.mapNode(cloudlet2.getCloudletId(), briteNode);
			// TopologicalGraph graph = new TopologicalGraph();
			// TopologicalNode node = new TopologicalNode(1);
			// graph.addNode(node);
