 ...
 */
public class NetworkExample4edited {
	...
	public static void main(String[] args) {
		...
		try {
			...
			NetworkTopology.addLink(datacenter0.getId(), broker.getId(), 10.0, 2);
//			NetworkTopology.addLink(host,datacenter0.getId(),10.0,2);
	...
	private static Datacenter createDatacenter(String name) {
		...
		System.out.println(" host ID = " + HostList.getById(hostList, 1));
