...
public class CloudSimExample8 {
	...
	private static Datacenter createDatacenter(String name) {
		...
		int bw = 1000000; // Kbit/s. Alanzy was 10000
	...
	public static class GlobalBroker extends SimEntity {
		...
		public void processEvent(SimEvent ev) {
			...
			case CREATE_BROKER:
				...
				// Create VMs and Cloudlets and send them to broker // another broker (Alanzy)
				setVmList(createVM(getBroker().getId(), 5, 100)); // creating 5 vms
				setCloudletList(createCloudlet(getBroker().getId(), 20, 100)); // creating 10 cloudlets
// 20 cloudlet and starting from 100 (VM, Cloudlet) (Alanzy)
